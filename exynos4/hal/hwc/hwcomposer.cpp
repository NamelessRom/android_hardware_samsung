...
hwc_module_t HAL_MODULE_INFO_SYM = {
    common: {
        ...
        name: "hwcomposer module wrapper",
        author: "",
        ...
        hwc_procs_t const* procs)
{
    ...
    // context is already set to 0      memset(&ctx->vendor_procs, 0, sizeof(struct hwc_hooks_t));
        ...
        struct hw_device_t** device)
{
    ...
    if (!strcmp(name, HWC_HARDWARE_COMPOSER)) {
        ...
        /* J.Ferrer - 19.10.2015 - We can't call open() on vendor blob, since it opens fb windows */
        ...
        ALOGV("%s: got vendor hwcomposer device 0x%08X", __FUNCTION__, (void *)(gVendorModule)); */
        ...
        *device = &dev->device.common;
        ...
        ALOGV("%s: got vendor hwcomposer device 0x%08X", __FUNCTION__, (void *)(dev->vendor));
