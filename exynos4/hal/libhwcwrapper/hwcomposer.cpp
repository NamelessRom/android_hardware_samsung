        ...
        hwc_procs_t const* procs)
{
    ...
    // context is already set to 0
    //memset(&ctx->vendor_procs, 0, sizeof(struct hwc_hooks_t));
        ...
        struct hw_device_t** device)
{
    ...
    if (!strcmp(name, HWC_HARDWARE_COMPOSER)) {
        ...
        //ALOGD("%s: got vendor hwcomposer device 0x%08X", __FUNCTION__, (void *)(gVendorModule));
